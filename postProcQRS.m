function [rPeaksMat,qrsOnCorr,qrsOffCorr] = postProcQRS(Fsignal,rPeaksMat,qOnMat,qOffMat,qualLim,visu)
...
for ch = 1 : nChan
    ...
    for hb = 1 : numBeats
        ...
        qrsOffCorr(idxBeats(hb),ch) = qrsOnCorr(idxBeats(hb),ch) + median(zeroHb(:,2)) - 1;
    end
